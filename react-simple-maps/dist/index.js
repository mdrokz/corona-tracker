...
var MapProvider = function MapProvider(_ref2) {
  ...
  var value = React.useMemo(function () {
    ...
    return {
      ...
      height: height,
      projection: proj,
      path: d3Geo.geoPath().projection(proj)
    };
...
function useZoomPan(_ref) {
  ...
  var wheelTimer = React.useRef(null);
  ...
  var point = React.useRef();
  var isPointerDown = React.useRef(false);
  var pointerOrigin = React.useRef();
...
var ZoomableGroup = function ZoomableGroup(_ref) {
  ...
  return React__default.createElement(
    ...
    render ? render(position) : React__default.createElement(
      "g",
